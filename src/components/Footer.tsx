      ...
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          ...
          <div className="flex flex-col gap-4">
            <h4 className="text-xs font-semibold uppercase tracking-[0.2em] mb-2">Practice Areas</h4>
            <div className="flex flex-col gap-3 text-sm text-gray-300">
              <Link to="/about" className="hover:text-white transition-colors">Corporate Law</Link>
              <Link to="/about" className="hover:text-white transition-colors">Cross-Border Transactions</Link>
              <Link to="/about" className="hover:text-white transition-colors">Intellectual Property</Link>
              <Link to="/about" className="hover:text-white transition-colors">Regulatory Compliance</Link>
            </div>
          </div>

          {/* CONTACT INFO */}
          <div className="flex flex-col gap-4">
            <h4 className="text-xs font-semibold uppercase tracking-[0.2em] mb-2">Connect</h4>
            <div className="flex flex-col gap-4 text-sm text-gray-300">
              <a href="mailto:info@glalpc.com" className="flex items-center gap-3 hover:text-white">
                <Mail size={16} /> info@glalpc.com
              </a>
              <a href="tel:+234000000000" className="flex items-center gap-3 hover:text-white">
