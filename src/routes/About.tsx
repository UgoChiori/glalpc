...
//               <div className="absolute -inset-2 border-2 border-slate-200 rounded-lg translate-x-4 translate-y-4 -z-10 hidden md:block"></div>
//               <img 
...
//         {/* Main Content Body */}
//         <div className="prose prose-slate max-w-none grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
...
//             </p>
//             <p className="font-medium text-slate-900 bg-slate-50 p-6 border-l-4 border-slate-800 italic">
