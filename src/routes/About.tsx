    ...
    <section className="bg-gray-900 text-gray-200 py-12 px-6 md:px-12 lg:px-24 transition-colors duration-300 min-h-screen">
      <div className="mx-auto">
        ...
        <div className="max-w-none grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
          ...
          <div className="space-y-6">
            <p className="text-slate-100 dark:text-gray-300 leading-relaxed">
              {t("about.body3")}
            </p>

            <p className="font-medium text-slate-100   p-6 border-l-4 border-slate-800 dark:border-gold-600 italic">
              {t("about.callout")}
            </p>
          </div>
